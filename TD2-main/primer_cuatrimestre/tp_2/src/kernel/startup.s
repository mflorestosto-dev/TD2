...
_stack_init:
    ...
    // Modo User (no se usa, ya que no tiene permisos para cambiar a otros modos)
    // MSR cpsr_c, #(USR_MODE | MASK)          // Modo User, IRQ/FIQ habilitados
    // LDR SP, = __stack_top_user__   // No se define stack pointer para modo User
